...
let SettingsController = class SettingsController {
    ...
    async getDefaults(area) { return { area, defaults: area ? await this.svc.getDefaults(area) : null }; }
    async upsert(body) { return { success: true, defaults: await this.svc.upsertDefaults(body) }; }
};
...
], SettingsController.prototype, "areas", null);
__decorate([

import { Controller, Delete, Get, Post, Query, Body, Res } from '@nestjs/common';
...
export class AnalyticsController {
  ...
  @Post('export')
  async export(@Res() res: Response, @Body() body: { areaIds?: number[]; ranges?: { start: number; end: number }[]; granularity?: 'record' | 'day' }) {
